"""my_art_23726 URL Configuration
...
admin.site.site_header = "My Art"
admin.site.site_title = "My Art Admin Portal"
admin.site.index_title = "My Art Admin"

# swagger
api_info = openapi.Info(
    title="My Art API",
    default_version="v1",
    description="API documentation for My Art App",
)
